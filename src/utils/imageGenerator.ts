...
export class ImageGenerator {
  ...
  private async createPreviewClone(originalNode: Element): Promise<HTMLElement> {
    ...
    // Remove collapsed toggle elements from clone so exported image has zero empty gaps
    clone.querySelectorAll('.quote-collapsed, .toggle-collapsed, .instance-hidden').forEach(el => el.remove());
